...
export default function InternationalBrandsPageV4() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <Helmet>
        ...
        <title>International Brands V4 - The Assembly</title>
      </Helmet>
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-slate-900 to-slate-700 text-white py-24 pt-32 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-8 relative z-10 text-center">
              <h1 className="text-5xl lg:text-7xl font-bold leading-tight mb-8">
                Turn Your{' '}
                <span className="text-red-400">1.65%</span> Canadian Conversion Into US-Level{' '}
                <span className="text-green-400">4.62%</span>
              </h1>
